...
const { addPageStates, getPageStatesDetails, getAllPageStatesList, updatePageStates, deletePageStatesDetails, getStatesHistory, getPageStatesDetailsByPageMasterId } = require("../../controllers/PMS2/pageStatesController");
const { verifyToken } = require("../../middleware/auth");
const router = express.Router();

router.post("/page_states", verifyToken, addPageStates);
router.get("/page_states/:id", verifyToken, getPageStatesDetails);
router.get("/page_states_by_page_id/:id", verifyToken, getPageStatesDetailsByPageMasterId);
