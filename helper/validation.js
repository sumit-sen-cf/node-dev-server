...
exports.accountMasterValidation = async (req, res, next) => {
    ...
    const schema = Joi.object({
        ...
        company_type_id: Joi.required(),
        category_id: Joi.optional(),
        description: Joi.optional(),
        account_owner_id: Joi.number().required(),
        website: Joi.optional(),
        turn_over: Joi.optional(),
        how_many_offices: Joi.optional(),
        connected_office: Joi.optional(),
        connect_billing_street: Joi.optional(),
        connect_billing_city: Joi.optional(),
        connect_billing_state: Joi.optional(),
        connect_billing_country: Joi.optional(),
        head_office: Joi.optional(),
        head_billing_street: Joi.optional(),
        head_billing_city: Joi.optional(),
        head_billing_state: Joi.optional(),
        head_billing_country: Joi.optional(),
        ...
        account_poc: Joi.array().items({
            contact_name: Joi.string().required(), // contact_name is a required string
            contact_no: Joi.number().min(1000000000).max(99999999999999).required(), // contact_no is a required number within specified range
            alternative_contact_no: Joi.optional(), // alternative_contact_no is an optional number within specified range
            email: Joi.optional(),
...
exports.updateArrayOfVendorValidation = async (req, res, next) => {
    ...
    const schema = Joi.object({
        ...
        bank_name: Joi.string(),
        home_state: Joi.string(),
        primary_page: Joi.string(),
        company_details: Joi.string(),
        created_by: Joi.number(),
